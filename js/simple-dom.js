/**
 * simple DOM for webworker
 */
// define window for web worker
var window = self.window = self;

(function simpleDOM(global) {
    ...
    global.HTMLSerializer = HTMLSerializer;
    global.voidMap = _voidMap;
	
	// init document
	Element.prototype.onsubmit = Element.prototype.onchange = Element.prototype.onfocus = null;
	
    global.document = global.document || new Document();

	// augment to allow running jQuery
    var fakeElement = Object.create(global.document);
	...
	fakeElement.ownerDocument = global.document;
	
	global.document.ownerDocument = global.document.documentElement = global.document;
	global.document.getElementById = function() {
		return fakeElement;
	};
	
	global.document.getElementsByTagName = global.document.getElementsByClassName = function() {
		return [fakeElement];
	};
